...
export default function UserData({ searchTerm, selectedUsers, setSelectedUsers }) {
      ...
      <table className='w-full text-left border-collapse'>
        <thead>
          <tr className='border-b border-gray-100 bg-gray-50/50 text-xs uppercase tracking-wider text-gray-500 font-semibold'>
            ...
            <th className='p-4 whitespace-nowrap text-center text-gray-500'>Properties</th>
        ...
        <tbody className="divide-y divide-gray-100 text-sm">
          {currentItems.map(user => (
            <tr key={user.id} className='hover:bg-slate-50/50 transition-colors bg-white/40'>
              ...
              <td className='p-4 text-gray-900 text-center font-medium'>0</td>
